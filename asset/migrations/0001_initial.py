# Generated by Django 2.2.1 on 2020-05-01 18:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AssetSKU',
            fields=[
                ('skuid', models.CharField(max_length=50, primary_key=True, serialize=False, verbose_name='货格编号')),
                ...
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asset.Asset', verbose_name='所属设备')),
            ],
            options={
