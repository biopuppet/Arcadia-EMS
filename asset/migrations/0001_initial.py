# Generated by Django 2.2.1 on 2020-06-03 11:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviewer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='baseapp_reviewed_assets', to=settings.AUTH_USER_MODEL, verbose_name='审批人')),
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='baseapp_sku', to='asset.AssetSKU', verbose_name='关联SKU')),
                ('transactor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='baseapp_transacted_assets', to=settings.AUTH_USER_MODEL, verbose_name='经办人')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseapp_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='asset.BaseApp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='asset_sets_app', to='asset.BaseApp', verbose_name='关联申请')),
