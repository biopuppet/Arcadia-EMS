...
class Asset(models.Model):
    ...
    category = models.ForeignKey(AssetCategory, on_delete=models.SET_NULL, related_name='assets', verbose_name='设备类别')
    ...
    transactor = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, related_name='assets', verbose_name='经办人')
    #  TODO: FK department
    department = models.ForeignKey(Department, on_delete=models.SET_NULL, related_name='assets', verbose_name='所在部门')
...
class AssetCreate(models.Model):
    id = models.CharField(max_length=30, unique=True, verbose_name='建账编号')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='建账时间')
    transactor = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, null=True, related_name='createassets',
                                   verbose_name='经办人')
    approver = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, null=True, related_name='createassets',
                                 verbose_name='审批人')
    ...
    asset_category = models.ForeignKey(AssetCategory, null=True, blank=True, on_delete=models.SET_NULL,
                                       related_name='createassets', verbose_name='设备类别')
    ...
    acquired_on = models.DateField(null=True, blank=True, verbose_name='购置日期')
    expire_on = models.DateField(null=True, blank=True, verbose_name='保质日期')
    asset_department = models.ForeignKey(Department, on_delete=models.SET_NULL, related_name='createassets',
                                         verbose_name='使用部门')
...
class AssetScrap(models.Model):
    id = models.CharField(max_length=30, unique=True, verbose_name='报废记录编号')
    created_on = models.DateField(auto_now_add=True, verbose_name='报废日期')
    asset = models.ForeignKey(Asset, on_delete=models.SET_NULL, related_name='scrapassets', verbose_name='设备编号')
    transactor = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, related_name='scrapassets',
                                   verbose_name='申请人')
    approver = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, related_name='scrapassets', verbose_name='审批人')
...
class AssetFix(models.Model):
    id = models.CharField(max_length=30, unique=True, verbose_name='维修记录编号')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='报修时间')
    asset = models.ForeignKey(Asset, on_delete=models.SET_NULL, related_name='fixassets', verbose_name='设备编号')
    transactor = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, related_name='fixassets', verbose_name='申请人')
    approver = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, related_name='fixassets', verbose_name='审批人')
    contact = models.CharField(max_length=20, default="", verbose_name="维修方联系方式")
    returned_at = models.DateTimeField(null=True, blank=True, verbose_name='维修结束日期')
